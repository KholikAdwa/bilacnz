...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, '𝐀𝟐𝕭𝖔𝖙', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), '𝐀𝟐𝕭𝖔𝖙', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
...
let fot = `Made by @${'62895610021383'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": "List Owner Lord A2",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang Lord A2", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " List Menu Lord A2",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " Source code Lord A2",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
