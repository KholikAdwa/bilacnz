...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  await conn.sendMessage(m.chat, {
    contacts: [{
    "displayName": "Owner Kholik",
      "vcard": "BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:ᴏᴡɴᴇʀ A2\nitem1.TEL;waid=62895610021383:62895610021383\nitem1.X-ABLabel:📍 Creator\nitem2.EMAIL;type=INTERNET:private\nitem2.X-ABLabel:💌 Email\nitem3.URL:https://chat.whatsapp.com/CBDjMXjHCLPElRqETBFD7O\nitem3.X-ABLabel:📮 Rest Api\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:ac\nitem4.X-ABLabel:🌍 Region | Otaku 🇯🇵\nitem5.X-ABLabel:───────[ LORD A2 ]───────\nEND:VCARD"
  }, {
